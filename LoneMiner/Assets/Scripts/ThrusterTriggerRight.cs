/*
 * ThrusterTriggerRight
 * 
 * Toggles on and off the thruster particles on players
 * ship when the ship is being rotated to the right.
 * 
 * Needs to be added as a component to all auxiliary thruster 
 * GameObjects that should be on when the ship rotates right.
 * 
...
public class ThrusterTriggerRight : MonoBehaviour
{
